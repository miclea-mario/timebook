...
const CalendarBodyError = ({ dates, showWeekend, view }) => {
    ...
    return (
      <div
        className={classnames(
          'border-t border-1 text-center pt-2 overflow-auto bg-red-200',
          view === 'monthly' ? 'h-32' : 'h-screen'
        )}
        key={card}
      />
    );
...
export default CalendarBodyError;
