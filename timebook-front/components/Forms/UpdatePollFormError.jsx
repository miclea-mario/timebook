    ...
    <form className="flex gap-2">
      <div className="card max-w-md flex flex-col gap-4 h-fit">
        ...
        <label className="w-full">
          ...
          <Textarea className="form-input bg-red-200 rounded w-full border-0" disabled />
        </label>
        <label className="w-full">
          Intrebarea
          <Textarea className="form-input bg-red-200 rounded w-full border-0" disabled />
        ...
        <label className="w-full mb-5">
          ...
          <Select disabled className="form-input bg-red-200 rounded w-full border-0" />
        </label>
...
export default UpdatePollFormError;
