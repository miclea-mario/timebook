...
const ApproveVacationFormError = () => {
  return (
    <div className="flex flex-col space-y-4">
      ...
      <label>
        ...
        <select
          className="mb-5 mt-1 text-gray-600 focus:outline-none focus:border focus:border-blue-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border bg-red-200"
          disabled
        ></select>
      </label>
...
export default ApproveVacationFormError;
