...
<head>
  ...
  >
    <div style="margin: 0 auto; max-width: 800px; ">
      ...
      <h2 style="color: #f4f4f4">Luna: {{lastMonthName}}</h2>
    ...
    {{/if}}
        ...
        <h4 style="font-size:16px; color:#fff">
          <em style="color: #53b0ae; font-size:18px;">”Un computer m-a bătut cândva la șah, dar nu a fost pe măsură pentru mine la kickboxing.”</em>
          <br/>
          Emo Philips
        </h4>
      </div>
