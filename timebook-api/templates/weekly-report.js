...
<head>
  ...
  >
    <div style="margin: 0 auto; max-width: 800px; ">
      ...
      <h2 style="color: #f4f4f4">Săptămâna: {{startOfInterval}} - {{endOfInterval}}</h2>
    ...
    {{/each}}
      ...
      {{/if}}
        ...
        <h4 style="font-size:16px; color:#fff">
          <em style="color: #53b0ae; font-size:18px;">”Pozițiile bune nu câștigă jocuri, mișcările bune câștigă.”</em>
          <br/>
          Gerald Abrahams
        </h4>
      </div>
